...
public class AddForm extends javax.swing.JPanel {
    ...
    private void setData(int id) throws ClassNotFoundException, SQLException {
        ...
        if(id != 0) {
            try {
                ...
                Map<String, Object> map = custCtrl.getData(id);
                
                if(map != null) {
                    System.out.println("EDIT");
                    System.out.println(String.valueOf((String) map.get("birth_date")));
                    System.out.println(String.valueOf((String) map.get("birth_date")).isEmpty());
    ...
    private void initComponents() {
        ...
        labelName.setText("Nama Nasabah");
...
//        System.out.println("phone: " + phone);
        ...
        boolean res = custCtrl.process(map);
