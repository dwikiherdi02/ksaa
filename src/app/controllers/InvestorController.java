...
public class InvestorController {
    ...
    private app.models.InvestorModel minv;
    
    public InvestorController() {
        try {
            this.minv = new app.models.InvestorModel();
        } catch (Exception e) {
    ...
    public List<Map<String, Object>> listTable(String param) {
        ...
        try {
            ResultSet res = this.minv.listData(param);
    ...
    public Map<String, Object> getData(int id) {
        ...
        try {
            ResultSet res = this.minv.getDataById(id);
    ...
    public boolean process(Map<String, Object> data) {
        ...
        if((int) data.get("id") != 0) {
            ...
            res = this.minv.update(data, id);
        } else {
            // insert
            res = this.minv.insert(data);
        }
        return res;
    }
    ...
    public boolean remove(int id) {
        ...
        try {
            boolean res = this.minv.delete(id);
            return res;
        } catch (Exception e) {
