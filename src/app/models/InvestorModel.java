...
public class InvestorModel extends Model {
    
    public InvestorModel() throws ClassNotFoundException {
        super("investor");
    }
    ...
    public ResultSet listData(String param) {
        try {
            ...
            String query = "SELECT id, name, nik, job, company_name FROM investor "
    ...
    public boolean insert(Map<String, Object> data) {
        ...
        try {
            String query = "INSERT INTO investor "
                         + "("
                            + "name, "
                            + "nik, "
                            + "birth_place, "
